...
def get_prod_data_config(prod: ProdsAvailable = ProdsAvailable.PROD_1030) -> DictConfig:
...
def get_training_config(
  ...
  if prod not in prod_available:
    raise ValueError(
      f"prod {prod} not available, " f"available prods: {prod_available}"
    )
